    ...
    options: {
      ...
      data: [
        ...
        },
        {
          ...
          relactiveDomValue: '',
          value: [
            {date: '2016-05-01', name: '模拟数据1', address: '模拟数据地址1'},
            {date: '2016-05-02', name: '模拟数据2', address: '模拟数据地址2'},
            {date: '2016-05-03', name: '模拟数据3', address: '模拟数据地址3'},
